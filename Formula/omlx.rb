class Omlx < Formula
  ...
  url "https://github.com/scaryrawr/omlx.git", branch: "main"
  version "main"
  license "Apache-2.0"

  livecheck do
    skip "Installs from the main branch"
  end
  ...
  def install
    ...
    # Install omlx with mflux-backed image support by default. Optionally add
    ...
    resource("mlx-audio").stage do
      ...
      inreplace "pyproject.toml", '"misaki>=0.9.4"', '"misaki>=0.7.4"'
